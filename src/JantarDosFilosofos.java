    ...
    public static void main(String[] args) {
        ...
        for (Filosofo filosofo : filosofos) {
            try {
                ...
                System.out.println("A execução foi interrompida."); // caso ocorra uma interrupção na espera, exibe uma
                                                                    // mensagem
            }
        }
        ...
        System.out.printf("%-15s %-20s %-20s %-20s %-20s%n", "NOME DO FILOSOFO", "TEMPO PENSANDO (ms)",
                "TEMPO PENSANDO (s)",
